          ...
          <div className={style.description}>
            ...
            <div className={style.photo}>
              <div className={style.photo__pc}>
                <img
                  src="./images/pc_b2b_platform.webp" alt="b2b platform for pc"/>
                <div className={style.photo__pc_productcard}>
                  <img
                    src="./images/b2b_productcard.webp" alt="b2b productcard for pc"
                  />
                </div>
              </div>
              <div className={style.photo__mobile}>
                <img
                  src="./images/mobile_b2b_platform.webp" alt="b2b platform for mobile phone"
                />
                <div className={style.photo__mobile_productcard}>
                  <img
                    src="./images/b2b_mobile_productcard.webp" alt="b2b productcard for mobile phone"/>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className={style.listItem} key={index}>
              <figure className={style.img__container}>
                <img
                  ...
                  src="./images/check_edited.webp" alt="checked"/>
              </figure>
