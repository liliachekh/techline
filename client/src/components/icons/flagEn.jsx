export function FlagEn({ className }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 513 342" className={className} >
      <g fill="#FFF">
        <path d="M0 0h513v341.3H0V0z" /><path d="M311.7 230 513 341.3v-31.5L369.3 230h-57.6zM200.3 111.3 0 0v31.5l143.7 79.8h56.6z" />
      </g>
      <g fill="#0052B4">
