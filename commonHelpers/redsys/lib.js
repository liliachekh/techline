...
module.exports = TRANSACTION_ERROR_CODES = {
  ...
  "107":
    "El banco emisor no permite una autorización automática. Es necesario contactar telefónicamente con su centro autorizador para obtener una aprobación Manual.  ",
  "109":
  ...
  "118":
    "Tarjeta inexistente o no dada de alta por banco emisor. (Error SIS0078)  ",
  "119":
  ...
  "167":
    "Debido a una sospecha de que la transacción es fraudulenta el banco emisor no permite una autorización automática. Es necesario contactar telefónicamente con su centro autorizador para obtener una aprobación manual.  ",
  ...
  "184":
    "Código exclusivo para transacciones Verified by Visa o MasterCard SecureCode. Transacción denegada por autenticación errónea.  ",
  "190":
    "Transacción denegada por el banco emisor pero sin que este dé detalles acerca del motivo.  ",
  "191":
  ...
  "207":
    "El banco emisor no permite una autorización automática. Es necesario contactar telefónicamente con su centro autorizador para obtener una aprobación manual. Además, el banco emisor considera que la tarjeta está en una situación de posible fraude.",
  "208":
  ...
  "501":
    "La conciliación no ha sido aceptada porque no se ha localizado la operación original, o bien, porque el banco emisor no ha dado respuesta dentro del time-out predefinido.",
  "502":
    "La conciliación no ha sido aceptada porque no se ha localizado la operación original, o bien, porque el banco emisor no ha dado respuesta dentro del time-out predefinido.",
  "503":
    "La conciliación no ha sido aceptada porque no se ha localizado la operación original, o bien, porque el banco emisor no ha dado respuesta dentro del time-out predefinido.",
  ...
  "904":
    "Hay un problema en la configuración del código de comercio. Contactar con RedSys para solucionarlo.",
  "909":
    "Error en la estabilidad de la plataforma de pagos de RedSys o en la de los sistemas de intercambio de Visa o MasterCard.",
  "912":
  ...
  "9994":
    "La operación está en espera de que el usuario seleccione una tarjeta en el wallet correspondiente (IUPAY!) ",
  "9998":
...
module.exports = SIS_ERROR_CODES = {
  SIS0007:
  ...
  SIS0030:
    "Error en un pago con tarjeta ha llegado un tipo de operación que no es ni pago ni preautorización",
  ...
  SIS0077:
    "Error el Ds_Merchant_Order no tiene las cuatro primeras posiciones numéricas. No se utiliza",
  ...
  SIS0122:
    "Valor del campo Ds_Merchant_DateFrecuency o no Ds_Merchant_SumTotal tiene formato incorrecto",
  ...
  SIS0133:
    "La fecha de Confirmación de Autenticación no puede superar en más de 45 días a la de Autenticación Previa.",
  ...
  SIS0199:
    "Error el número de operaciones supera el límite permitido para el comercio",
  SIS0200:
  ...
  SIS0219:
    "Error el número de operaciones de la tarjeta supera el límite permitido para el comercio",
  SIS0220:
  ...
  SIS0295:
    "Se ha denegado una operación que fue enviada en el mismo minuto para evitar duplic.",
  SIS0319:
